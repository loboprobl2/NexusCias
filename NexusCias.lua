-- NexusCias Unificado - Gerado por ChatGPT
...
-- Load core modules
local farming = require(script.Parent.modules.farming)
local combat = require(script.Parent.modules.combat)
local movement = require(script.Parent.modules.movement)
local antiDetection = require(script.Parent.modules.antiDetection)
local logging = require(script.Parent.modules.logging)
